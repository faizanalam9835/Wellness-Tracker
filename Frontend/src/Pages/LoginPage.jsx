          ...
          <div className="hidden lg:block relative bg-[#e0b6f5]">
            ...
            <div className="relative z-10 p-10 flex flex-col h-full justify-center">
              ...
              >
                ...
                <p className="mt-3 text-sm opacity-90">Sign in to continue your journey. Smooth animations and delightful micro-interactions make everything feel alive.</p>
              </motion.div>
            </div>
          </div>
                ...
                {showForgotPassword ? (
                  ...
                  >
                    ...
                    <div className="text-center text-sm text-gray-400">
                      ...
                      <a href="/signup" className="text-[#6e3aa8] font-medium hover:underline">
                        Create one
                      </a>
                    </div>
                  </motion.form>
